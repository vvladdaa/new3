...
numbers6 = input("Введіть цілі числа, розділені пробілами: ").split()
numbers6 = [int(num) for num in numbers6]
sorted6 = sorted(numbers6)
result6 = []
left6 = 0
right6 = len(sorted6) - 1
while left6 <= right6:
    if left6 == right6:
        result6.append(sorted6[left6])
    else:
        result6.append(sorted6[left6])
        result6.append(sorted6[right6])
    left6 += 1
    right6 -= 1
print(f"Початковий список: {numbers6}")
print(f"Відсортований список з чергуванням: {result6}")
